...
brose.data = read.delim("brose2005ecology_adbm2008/acquired_data/Full body size data base Owen altered.txt", as.is=T)
...
pdf("brose2005ecology_adbm2008/predation_matrices.pdf", width=12, height=8,
    paper = "a4r")
...
for(i in 1:9){
    ...
    saveRDS(all.web.info, file=paste("brose2005ecology_adbm2008/extracted_foodwebs/", as.character(web.info1[i,2]), ".web.RDS", sep=""))    
}
