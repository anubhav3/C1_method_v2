# 20.11.2021
# We plot the MSE vs TSS for different food webs
...
# Computing the max SE over all the food webs
...
fname <- paste("results/misc/", "r_SE_", desc, ".png", sep = "")
...
fname_v2 <- paste("results/misc/", "r_SE_", desc, "_v2.png", sep = "")

plot_all_v2 <- ggarrange(plot_list[[1]], plot_list[[2]], plot_list[[3]], plot_list[[4]], plot_list[[5]],
                      plot_list[[6]], plot_list[[7]], plot_list[[8]], plot_list[[9]], plot_list[[10]],
                      plot_list[[11]], plot_list[[12]],
                      nrow = 4, ncol = 4, common.legend = TRUE, legend ="bottom"
)
...
# ggsave(filename = fname_v2, plot = plot_all_v2, height = 30, width = 35, units = "cm")
